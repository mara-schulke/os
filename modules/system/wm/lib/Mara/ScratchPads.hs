...
scratchPads =
    ...
    where spawnNetflix  = "chromium --kiosk --new-window --class=netflix --user-data-dir='/home/mara/.config/netflix'"
          findNetfix    = className =? "netflix"
          manageNetflix = doRectFloat 1

          spawnChat     = "chromium --kiosk --new-window --class=chat --user-data-dir='/home/mara/.config/chat'"
